...
export default function CheckoutPage() {
    ...
    <div className="container mx-auto px-4 py-8">
                    ...
                    {items.map((item, key) => (
                        <li key={key} className="flex flex-col gap-2 border-b pb-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button variant="outline" size="sm" onClick={() => addItem({...item, quantity: 1})} className="bg-black text-white">+</Button>
                            </div>
                        </li>
                    ))}
                </ul>
        ...
        <form action={checkoutAction} className="max-w-md mx-auto">
            ...
            {/*<Button onClick={() => clearCart()} variant="default" className="w-full bg-black text-white"> Clear Cart </Button> */}
        </form>
    </div>);
}